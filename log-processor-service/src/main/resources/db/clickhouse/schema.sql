-- Run against ClickHouse (database observability must exist).
-- JDBC URL default database: observability
...
CREATE MATERIALIZED VIEW IF NOT EXISTS log_clusters_mv TO log_clusters
AS
SELECT
    tenant_id,
    service_name,
